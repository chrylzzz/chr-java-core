...
//        String s = DateHelper.formatDate(new Date(), DateHelper.pattern_time);
//        Date date = DateHelper.parseString(s, DateHelper.pattern_date);
//        Date date2= DateHelper.parseString(s, DateHelper.pattern_time);
//        String s2 = DateHelper.formatDate(date, DateHelper.pattern_time);
//        String s1 = DateHelper.formatString("2019-12-04 00:00:00");
//        int timesper = DateHelper.getTimesper(s1);
//        String s3 = DateHelper.formatDateTime(date2);
//        String s4 = DateHelper.formatDateTime(s);
//        Date date1 = DateHelper.parseString(s,pattern_date);
